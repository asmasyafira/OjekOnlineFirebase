package com.example.ojekonline.maps
...
//disini kita bikin function2 buat SessionManager, untuk dibikin di kelas2 lain

//SessionManager function longitude dkk
class GPSTrack(c: Context) : Service(), LocationListener {
    ...
    companion object {
        private val MIN_DISTANCE = 1.toLong() //10meter
    ...
    fun showSettingGPS() {
        ...
        alertBuilder
            .setMessage("GPS is not enabled, do u want to go to settings menu")
